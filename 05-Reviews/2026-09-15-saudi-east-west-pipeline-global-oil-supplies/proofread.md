---
title: "Saudi Arabia’s Oil Bypass Is Down. What It Means for Global Supplies"
date: "2026-09-15"
desk: "news"
...
approved_by: "Sophie"
approved_at: "2026-09-15T18:27:58+02:00"
source_artifact: "creative-edit.md"
next_artifact: "../../06-Design/2026-09-15-saudi-east-west-pipeline-global-oil-supplies/design.md"
next_stage: "design"
sophie_decision: "approved-for-design"
sophie_decision_date: "2026-09-15T18:27:58+02:00"
model_provenance:
  stage: "proofread"
  agent: "news-editor"
  model: "gpt-5.6-luna"
...
source_ledger: "sources-ledger.json"
word_count: 1178
---

# Proofread: Saudi Arabia’s Oil Bypass Is Down. What It Means for Global Supplies

## Proofread result

- [x] Spelling and punctuation checked
- [x] British English checked where required
- [x] Headings and Markdown checked
- [x] Links and attribution checked
- [x] Figures and repeated claims checked
- [x] News-specific safeguards checked
- [x] No unnecessary creative rewrite made
...
- The Saudi Press Agency page at `https://www.spa.gov.sa/en/N2674017` still returns only its headline through the extractor. Its full statement requires manual checking before publication.
- The report that the pipeline is expected to resume soon remains an attributed expectation from US Energy Secretary Chris Wright, not confirmation of a restart.
- Repair status, tanker loadings, inventories and dated market figures remain time-sensitive and need a final refresh before publication.

## Full proofread article
...
The biggest mistake is treating seven million barrels a day of design capacity as seven million barrels a day of immediate lost supply.[6][10]
The useful question is simpler: what is still moving, where is it going, and how many days remain before stored barrels stop doing the job?[13][19]
...
- Current stage: Proofread
- Source artifacts: `creative-edit.md`, upstream Draft/Brief/SEO artifacts, `sources-ledger.json` and local `evidence/`
- Completed work: narrow spelling, punctuation, British-English, Markdown, link, source-label, attribution and consistency pass; approved global article body carried forward; no creative rewrite; no substantive article wording change
- Verified sources / evidence carried forward: Creative Edit’s filtered ledger copied unchanged; 14 cited source IDs remain mapped to the same URLs; strict evidence verification remains required against this artifact; fresh review extracts and carried-forward Draft extracts remain in `evidence/`; direct Saudi Press Agency check saved outside the repository at `/tmp/dadbot-proofread-spa.txt` and remains headline-only
- Approved decisions and constraints: Sophie approved Creative Edit → Proofread on 2026-09-15 at 18:00:25 +02:00 and Proofread → Design on 2026-09-15 at 18:27:58 +02:00; preserve the global supply angle, calm News voice, capacity/throughput/lost-supply distinction and cover-free rule
- Permitted changes at this stage: spelling, punctuation, British English, Markdown, links, attribution and consistency only
- Open questions / blockers: manually inspect the full Saudi primary statement; confirm whether technical teams achieved a partial restart; refresh Yanbu and Egyptian-port stocks, tanker loadings and dated IEA/market figures before publication; do not turn Wright’s expectation into a confirmed restart
- Quality checks completed: Proofread article carried forward at 1,178 words; reader-facing source labels normalized; fresh Saudi Press Agency direct check completed and saved outside the repository at `/tmp/dadbot-proofread-spa.txt`; Proofread structural contract passed; YAML parse passed; `sources.py verify --evidence --strict` passed with 47/101 sentences carrying provenance, 14 distinct cited sources and no unevidenced cited sources; exact article-body comparison with Creative Edit passed; placeholder/corruption sweep passed; no cover metadata; Design artifact created at `../../06-Design/2026-09-15-saudi-east-west-pipeline-global-oil-supplies/design.md`; no Approval or public article artifact; temporary Hugo v0.163.3 build passed with 222 pages and 32 static files; 212 HTML files scanned with no Proofread title, slug or workflow markers in public output; `git diff --check` passed
- Next gate: Design → Final Approval
- Sophie decision required: Design package is awaiting approval to move to Final Approval

## Approval gate

**Proofread → Design:** approved by Sophie on 2026-09-15 at 18:27:58 +02:00. Design package created at `../../06-Design/2026-09-15-saudi-east-west-pipeline-global-oil-supplies/design.md`; awaiting the Design → Final Approval decision.

*Proofread approved for Design. Not published until later gates are approved by Sophie.*

## Sources

[6] https://www.iea.org/about/oil-security-and-emergency-response/strait-of-hormuz — Strait of Hormuz
    ...
    > "Around 600 kb/d, or just 4%, of the region’s crude flows are routed into Europe."
[8] https://www.galvnews.com/news_reuters/business/oil-prices-rise-as-saudi-pipeline-outage-fresh-attacks-raise-supply-concerns/article_6850529a-f626-5f0d-a584-23cdcae04141.html — Reuters copy — Oil prices rise as Saudi pipeline outage and fresh attacks raise supply concerns
...
[9] https://www.eia.gov/outlooks/steo/report/global_oil.php — U.S. Energy Information Administration — Global oil market outlook
...
[10] https://www.pbs.org/newshour/world/saudi-oil-pipeline-hit-in-strikes-will-be-mostly-out-of-service-for-several-weeks — Associated Press via PBS — Saudi oil pipeline hit in strikes will be mostly out of service for several weeks
...
[11] https://www.theguardian.com/world/2026/sep/14/saudi-pipeline-drone-attack-houthis-global-oil-supply-prices — The Guardian — Satellite images show extent of damage to major Saudi pipeline
...
[12] https://www.bbc.com/news/articles/c62m933465eo — BBC News — Saudi Arabia shuts key oil pipeline after drone attack launched from Iraq
    > "The 1,200km (745 mile) pipeline has helped Saudi Arabia - the world's largest crude oil exporter - bypass the Strait of Hormuz."
[13] https://www.cnbc.com/2026/09/15/oil-prices-saudi-arabia-east-west-pipeline-iran.html — CNBC — Oil’s next test: Saudi Arabia races to restore a key safety valve for prices
...
[14] https://dailycaller.com/2026/09/14/saudi-arabia-oil-pipeline-straight-hormuz-attacks-iran-war — The Daily Caller — Saudi Arabia’s Oil Lifeline Just Went Down
...
[15] https://www.cnn.com/2026/09/14/economy/saudi-east-west-pipeline-shut-oil-market — CNN — Saudi Arabia has shut a critical oil pipeline: why it matters
...
[16] https://www.reuters.com/business/energy/oil-prices-rise-saudi-pipeline-outage-fresh-attacks-raise-supply-concerns-2026-09-15 — Reuters — Oil prices rise as Saudi pipeline outage, fresh attacks raise supply concerns
...
[19] https://www.thetrucker.com/trucking-news/business/what-the-closure-of-saudi-arabias-east-west-pipeline-could-mean-for-oil-flows — Associated Press via The Trucker — What the closure of Saudi Arabia’s East-West pipeline could mean for oil flows
...
[20] https://aa.com.tr/en/economy/saudi-east-west-pipeline-expected-to-resume-operations-soon-us-energy-chief/4057238 — Saudi East-West pipeline expected to resume operations soon: US energy chief
    ...
    > "Before the closure, it had been carrying about 4 million to 5 million barrels of crude per day, equivalent to roughly 4%-5% of global oil supply."
[21] https://www.iea.org/commentaries/how-global-oil-supplies-have-readjusted-to-help-fill-the-huge-gap-left-by-the-strait-of-hormuz-shock — How global oil supplies have readjusted to help fill the huge gap left by the Strait of Hormuz shock
    ...
    > "The crisis has set in motion major shifts in global oil trade flows, including significant increases in supplies from producers outside the Middle East being shipped from the Atlantic Basin to markets in Asia."
    > "The Middle East ranked as the world's largest source of aviation fuel to international markets in 2025, so the effective closure of the Strait of Hormuz at the end of February removed a significant share of global jet fuel supply from the market."
[22] https://www.aljazeera.com/news/2026/9/14/why-saudi-arabias-east-west-pipeline-matters-for-global-oil — Why Saudi Arabia’s East-West pipeline matters for global oil
